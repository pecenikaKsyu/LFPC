...
Vn_brut = input("Defineste elementele neterminale (separandu-le prin spatiu)\n")
vn = Vn_brut.split(" ")
Vt_brut = input("Defineste elementele terminale (separandu-le prin spatiu)\n")
vt = Vt_brut.split(" ")
...
for i in range(nr_rel):
    r = input()
    rules.append(r)
wordFA = input("Introdu cuvantul spre verificare: \n")
diction = {}
firsts = {}
follows = {}
computeAllFirsts()
